...
class ExcelSchemaPromptBuilder:
    ...
    def build_system_prompt(self, extra_instructions: Optional[str] = None, allow_sql_execution: bool = False) -> str:
        ...
        if allow_sql_execution:
            ...
            lines.append("- When user asks about specific weeks or date ranges, use week_nbr for filtering")
            lines.append("- Note: week_nbr values will be automatically translated to readable dates in the display")
            lines.append("")
